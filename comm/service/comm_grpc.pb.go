...
type CommServiceClient interface {
	...
	// 遠端控制
	Iot627Remote(ctx context.Context, in *Iot627RemoteRequest, opts ...grpc.CallOption) (*CommResponse, error)
	// 回傳所有控制數值
	Iot627GetControlValue(ctx context.Context, in *Iot627GetControlValueRequest, opts ...grpc.CallOption) (*CommResponse, error)
}
...
func (x *commServiceIot627TimingClient) Recv() (*CommResponse, error) {
	m := new(CommResponse)
...
func (c *commServiceClient) Iot627Remote(ctx context.Context, in *Iot627RemoteRequest, opts ...grpc.CallOption) (*CommResponse, error) {
...
func (c *commServiceClient) Iot627GetControlValue(ctx context.Context, in *Iot627GetControlValueRequest, opts ...grpc.CallOption) (*CommResponse, error) {
	out := new(CommResponse)
...
type CommServiceServer interface {
	...
	// 遠端控制
	Iot627Remote(context.Context, *Iot627RemoteRequest) (*CommResponse, error)
	// 回傳所有控制數值
	Iot627GetControlValue(context.Context, *Iot627GetControlValueRequest) (*CommResponse, error)
...
func (UnimplementedCommServiceServer) Iot627Remote(context.Context, *Iot627RemoteRequest) (*CommResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Iot627Remote not implemented")
}
func (UnimplementedCommServiceServer) Iot627GetControlValue(context.Context, *Iot627GetControlValueRequest) (*CommResponse, error) {
...
func (x *commServiceIot627TimingServer) Send(m *CommResponse) error {
