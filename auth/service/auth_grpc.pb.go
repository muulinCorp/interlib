...
type AuthServiceClient interface {
	...
	GetUserCacheKey(ctx context.Context, in *ValidateTokenRequest, opts ...grpc.CallOption) (*GetUserCacheKeyResponse, error)
...
func (c *authServiceClient) GetUserCacheKey(ctx context.Context, in *ValidateTokenRequest, opts ...grpc.CallOption) (*GetUserCacheKeyResponse, error) {
	out := new(GetUserCacheKeyResponse)
	err := c.cc.Invoke(ctx, "/service.AuthService/GetUserCacheKey", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	GetUserCacheKey(context.Context, *ValidateTokenRequest) (*GetUserCacheKeyResponse, error)
...
func (UnimplementedAuthServiceServer) GetUserCacheKey(context.Context, *ValidateTokenRequest) (*GetUserCacheKeyResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUserCacheKey not implemented")
}
...
func _AuthService_GetUserCacheKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ValidateTokenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).GetUserCacheKey(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service.AuthService/GetUserCacheKey",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GetUserCacheKey(ctx, req.(*ValidateTokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AuthService_GetUserCacheKey_Handler,
		},
		{
