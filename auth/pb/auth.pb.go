...
type GetScadaTokenInfoRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetScadaTokenInfoRequest) Reset() {
	*x = GetScadaTokenInfoRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetScadaTokenInfoRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetScadaTokenInfoRequest) ProtoMessage() {}

func (x *GetScadaTokenInfoRequest) ProtoReflect() protoreflect.Message {
	mi := &file_auth_proto_auth_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetScadaTokenInfoRequest.ProtoReflect.Descriptor instead.
func (*GetScadaTokenInfoRequest) Descriptor() ([]byte, []int) {
	return file_auth_proto_auth_proto_rawDescGZIP(), []int{2}
}

func (x *GetScadaTokenInfoRequest) GetHost() string {
	if x != nil {
		return x.Host
	}
	return ""
...
func (x *GetScadaTokenInfoRequest) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *GetScadaTokenInfoRequest) GetMethod() string {
	if x != nil {
		return x.Method
	}
	return ""
...
func (x *GetScadaTokenInfoRequest) GetApiPath() string {
	if x != nil {
		return x.ApiPath
	}
	return ""
...
type GetScadaTokenInfoResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetScadaTokenInfoResponse) Reset() {
	*x = GetScadaTokenInfoResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetScadaTokenInfoResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetScadaTokenInfoResponse) ProtoMessage() {}

func (x *GetScadaTokenInfoResponse) ProtoReflect() protoreflect.Message {
	mi := &file_auth_proto_auth_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetScadaTokenInfoResponse.ProtoReflect.Descriptor instead.
func (*GetScadaTokenInfoResponse) Descriptor() ([]byte, []int) {
	return file_auth_proto_auth_proto_rawDescGZIP(), []int{3}
}

func (x *GetScadaTokenInfoResponse) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *GetScadaTokenInfoResponse) GetAccount() string {
	if x != nil {
		return x.Account
	}
	return ""
...
func (x *GetScadaTokenInfoResponse) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *GetScadaTokenInfoResponse) GetRoles() []string {
	if x != nil {
		return x.Roles
	}
	return nil
...
func (x *GetScadaTokenInfoResponse) GetUsage() string {
	if x != nil {
		return x.Usage
	}
	return ""
...
var file_auth_proto_auth_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x06, 0x75, 0x73, 0x65, 0x61, 0x67, 0x65, 0x22, 0x76, 0x0a, 0x18, 0x47,
	0x65, 0x74, 0x53, 0x63, 0x61, 0x64, 0x61, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x49, 0x6e, 0x66, 0x6f,
	...
	0x61, 0x74, 0x68, 0x22, 0x85, 0x01, 0x0a, 0x19, 0x47, 0x65, 0x74, 0x53, 0x63, 0x61, 0x64, 0x61,
	...
	0x72, 0x6f, 0x6c, 0x65, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x75, 0x73, 0x61, 0x67, 0x65, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x75, 0x73, 0x61, 0x67, 0x65, 0x22, 0x23, 0x0a, 0x11, 0x47,
	...
	0x6d, 0x61, 0x69, 0x6c, 0x32, 0xb3, 0x04, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65, 0x72,
	...
	,
	...
	0x74, 0x68, 0x2e, 0x46, 0x6f, 0x72, 0x67, 0x65, 0x74, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72,
	0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x4d, 0x0a, 0x14, 0x47,
	0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x42, 0x79, 0x41, 0x63, 0x63, 0x6f,
	0x75, 0x6e, 0x74, 0x12, 0x18, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x47, 0x65, 0x74, 0x55, 0x73,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x09, 0x5a, 0x07, 0x61, 0x75,
...
var file_auth_proto_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_auth_proto_auth_proto_goTypes = []interface{}{
	...
	(*GetScadaTokenInfoRequest)(nil),  // 2: auth.GetScadaTokenInfoRequest
	(*GetScadaTokenInfoResponse)(nil), // 3: auth.GetScadaTokenInfoResponse
	(*GetAccountRequest)(nil),         // 4: auth.GetAccountRequest
	(*GetAccountResponse)(nil),        // 5: auth.GetAccountResponse
	(*IsAccountExistRequest)(nil),     // 6: auth.IsAccountExistRequest
	(*IsAccountExistResponse)(nil),    // 7: auth.IsAccountExistResponse
	(*CreateInvitationRequest)(nil),   // 8: auth.CreateInvitationRequest
	(*CreateInvitationResponse)(nil),  // 9: auth.CreateInvitationResponse
	(*ForgetPasswordRequest)(nil),     // 10: auth.ForgetPasswordRequest
	(*ForgetPasswordResponse)(nil),    // 11: auth.ForgetPasswordResponse
	(*GetUserInfoRequest)(nil),        // 12: auth.GetUserInfoRequest
	(*GetUserInfoResponse)(nil),       // 13: auth.GetUserInfoResponse
}
var file_auth_proto_auth_proto_depIdxs = []int32{
	0,  // 0: auth.AuthService.GetTokenInfo:input_type -> auth.GetTokenInfoRequest
	2,  // 1: auth.AuthService.GetScadaTokenInfo:input_type -> auth.GetScadaTokenInfoRequest
	4,  // 2: auth.AuthService.GetAccount:input_type -> auth.GetAccountRequest
	6,  // 3: auth.AuthService.IsAccountExist:input_type -> auth.IsAccountExistRequest
	8,  // 4: auth.AuthService.CreateInvitation:input_type -> auth.CreateInvitationRequest
	10, // 5: auth.AuthService.ForgetPassword:input_type -> auth.ForgetPasswordRequest
	12, // 6: auth.AuthService.GetUserInfoByAccount:input_type -> auth.GetUserInfoRequest
	1,  // 7: auth.AuthService.GetTokenInfo:output_type -> auth.GetTokenInfoResponse
	3,  // 8: auth.AuthService.GetScadaTokenInfo:output_type -> auth.GetScadaTokenInfoResponse
	5,  // 9: auth.AuthService.GetAccount:output_type -> auth.GetAccountResponse
	7,  // 10: auth.AuthService.IsAccountExist:output_type -> auth.IsAccountExistResponse
	9,  // 11: auth.AuthService.CreateInvitation:output_type -> auth.CreateInvitationResponse
	11, // 12: auth.AuthService.ForgetPassword:output_type -> auth.ForgetPasswordResponse
	13, // 13: auth.AuthService.GetUserInfoByAccount:output_type -> auth.GetUserInfoResponse
...
func file_auth_proto_auth_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_auth_proto_auth_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetScadaTokenInfoRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_auth_proto_auth_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetScadaTokenInfoResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
