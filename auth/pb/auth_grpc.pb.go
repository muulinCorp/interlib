...
type AuthServiceClient interface {
	...
	// 取得Scada使用者資訊 (包括role的permission驗證)
	GetScadaTokenInfo(ctx context.Context, in *GetScadaTokenInfoRequest, opts ...grpc.CallOption) (*GetScadaTokenInfoResponse, error)
	// 取得帳號
...
func (c *authServiceClient) GetScadaTokenInfo(ctx context.Context, in *GetScadaTokenInfoRequest, opts ...grpc.CallOption) (*GetScadaTokenInfoResponse, error) {
	out := new(GetScadaTokenInfoResponse)
	err := c.cc.Invoke(ctx, "/auth.AuthService/GetScadaTokenInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	// 取得Scada使用者資訊 (包括role的permission驗證)
	GetScadaTokenInfo(context.Context, *GetScadaTokenInfoRequest) (*GetScadaTokenInfoResponse, error)
	// 取得帳號
...
func (UnimplementedAuthServiceServer) GetScadaTokenInfo(context.Context, *GetScadaTokenInfoRequest) (*GetScadaTokenInfoResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetScadaTokenInfo not implemented")
}
...
func _AuthService_GetScadaTokenInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetScadaTokenInfoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).GetScadaTokenInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auth.AuthService/GetScadaTokenInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GetScadaTokenInfo(ctx, req.(*GetScadaTokenInfoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetScadaTokenInfo",
			Handler:    _AuthService_GetScadaTokenInfo_Handler,
		},
		{
