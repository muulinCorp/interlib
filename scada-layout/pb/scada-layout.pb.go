...
type GetFieldListRequest_FieldType int32

const (
	GetFieldListRequest_ALL GetFieldListRequest_FieldType = 0
	GetFieldListRequest_GET GetFieldListRequest_FieldType = 1
	GetFieldListRequest_SET GetFieldListRequest_FieldType = 2
)

// Enum value maps for GetFieldListRequest_FieldType.
var (
	GetFieldListRequest_FieldType_name = map[int32]string{
		0: "ALL",
		1: "GET",
		2: "SET",
	}
	GetFieldListRequest_FieldType_value = map[string]int32{
		"ALL": 0,
		"GET": 1,
		"SET": 2,
	}
...
func (x GetFieldListRequest_FieldType) Enum() *GetFieldListRequest_FieldType {
	p := new(GetFieldListRequest_FieldType)
	*p = x
	return p
}

func (x GetFieldListRequest_FieldType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (GetFieldListRequest_FieldType) Descriptor() protoreflect.EnumDescriptor {
	return file_scada_layout_proto_scada_layout_proto_enumTypes[2].Descriptor()
}

func (GetFieldListRequest_FieldType) Type() protoreflect.EnumType {
	return &file_scada_layout_proto_scada_layout_proto_enumTypes[2]
}

func (x GetFieldListRequest_FieldType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use GetFieldListRequest_FieldType.Descriptor instead.
func (GetFieldListRequest_FieldType) EnumDescriptor() ([]byte, []int) {
	return file_scada_layout_proto_scada_layout_proto_rawDescGZIP(), []int{3, 1}
}
...
func (GetReportResponse_DefaultChart_DisplayType) Descriptor() protoreflect.EnumDescriptor {
	return file_scada_layout_proto_scada_layout_proto_enumTypes[3].Descriptor()
}

func (GetReportResponse_DefaultChart_DisplayType) Type() protoreflect.EnumType {
	return &file_scada_layout_proto_scada_layout_proto_enumTypes[3]
}
...
type GetFieldListRequest struct {
	...
	FieldType     GetFieldListRequest_FieldType   `protobuf:"varint,3,opt,name=field_type,json=fieldType,proto3,enum=scada_layout.GetFieldListRequest_FieldType" json:"field_type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetFieldListRequest) GetFieldType() GetFieldListRequest_FieldType {
	if x != nil {
		return x.FieldType
	}
	return GetFieldListRequest_ALL
}
...
const file_scada_layout_proto_scada_layout_proto_rawDesc = "" +
	"\n" +
	"%scada-layout/proto/scada-layout.proto\x12\fscada_layout\x1a\x1bgoogle/protobuf/empty.proto\"#\n" +
	"\tFieldList\x12\x16\n" +
	...
	"\x04type\x18\x02 \x01(\x0e2-.scada_layout.GetFieldListRequest.RequestTypeR\x04type\x12J\n" +
	"\n" +
	"field_type\x18\x03 \x01(\x0e2+.scada_layout.GetFieldListRequest.FieldTypeR\tfieldType\" \n" +
...
var (
	...
	file_scada_layout_proto_scada_layout_proto_rawDescData []byte
)
...
func file_scada_layout_proto_scada_layout_proto_rawDescGZIP() []byte {
	file_scada_layout_proto_scada_layout_proto_rawDescOnce.Do(func() {
		file_scada_layout_proto_scada_layout_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_scada_layout_proto_scada_layout_proto_rawDesc), len(file_scada_layout_proto_scada_layout_proto_rawDesc)))
	})
	return file_scada_layout_proto_scada_layout_proto_rawDescData
}

var file_scada_layout_proto_scada_layout_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_scada_layout_proto_scada_layout_proto_msgTypes = make([]protoimpl.MessageInfo, 39)
var file_scada_layout_proto_scada_layout_proto_goTypes = []any{
	(UnitType)(0),                                      // 0: scada_layout.UnitType
	(GetFieldListRequest_RequestType)(0),               // 1: scada_layout.GetFieldListRequest.RequestType
	(GetFieldListRequest_FieldType)(0),                 // 2: scada_layout.GetFieldListRequest.FieldType
	(GetReportResponse_DefaultChart_DisplayType)(0),    // 3: scada_layout.GetReportResponse.DefaultChart.DisplayType
	(*FieldList)(nil),                                  // 4: scada_layout.FieldList
	(*GetFieldsTagsResponse)(nil),                      // 5: scada_layout.GetFieldsTagsResponse
	(*GetReportFieldsResponse)(nil),                    // 6: scada_layout.GetReportFieldsResponse
	(*GetFieldListRequest)(nil),                        // 7: scada_layout.GetFieldListRequest
	(*GetFieldListResponse)(nil),                       // 8: scada_layout.GetFieldListResponse
	(*GetSmartDefrostResponse)(nil),                    // 9: scada_layout.GetSmartDefrostResponse
	(*GetReportResponse)(nil),                          // 10: scada_layout.GetReportResponse
	(*GetScenarioResponse)(nil),                        // 11: scada_layout.GetScenarioResponse
	(*GetAlarmFieldsResponse)(nil),                     // 12: scada_layout.GetAlarmFieldsResponse
	(*GetElectricityDemandResponse)(nil),               // 13: scada_layout.GetElectricityDemandResponse
	(*GetFieldsTagsResponse_FieldTag)(nil),             // 14: scada_layout.GetFieldsTagsResponse.FieldTag
	(*GetFieldsTagsResponse_IdWithName)(nil),           // 15: scada_layout.GetFieldsTagsResponse.IdWithName
	(*GetReportFieldsResponse_Field)(nil),              // 16: scada_layout.GetReportFieldsResponse.Field
	nil,                                                // 17: scada_layout.GetReportFieldsResponse.Field.TransEntry
	(*GetSmartDefrostResponse_GroupDetail)(nil),        // 18: scada_layout.GetSmartDefrostResponse.GroupDetail
	(*GetSmartDefrostResponse_ElementDetail)(nil),      // 19: scada_layout.GetSmartDefrostResponse.ElementDetail
	(*GetSmartDefrostResponse_ServerSettingField)(nil), // 20: scada_layout.GetSmartDefrostResponse.ServerSettingField
	(*GetReportResponse_ReportSettingDetail)(nil),      // 21: scada_layout.GetReportResponse.ReportSettingDetail
	(*GetReportResponse_PdfInputDetail)(nil),           // 22: scada_layout.GetReportResponse.PdfInputDetail
	(*GetReportResponse_ExcelIntervalDetail)(nil),      // 23: scada_layout.GetReportResponse.ExcelIntervalDetail
	(*GetReportResponse_IntervalDetail)(nil),           // 24: scada_layout.GetReportResponse.IntervalDetail
	(*GetReportResponse_DefaultChart)(nil),             // 25: scada_layout.GetReportResponse.DefaultChart
	(*GetReportResponse_DefaultChart_ChartField)(nil),  // 26: scada_layout.GetReportResponse.DefaultChart.ChartField
	nil, // 27: scada_layout.GetReportResponse.DefaultChart.ChartField.TransEntry
	(*GetScenarioResponse_ElementScenario)(nil),                  // 28: scada_layout.GetScenarioResponse.ElementScenario
	(*GetScenarioResponse_ScenarioDetail)(nil),                   // 29: scada_layout.GetScenarioResponse.ScenarioDetail
	(*GetScenarioResponse_FieldAction)(nil),                      // 30: scada_layout.GetScenarioResponse.FieldAction
	(*GetAlarmFieldsResponse_FieldDetail)(nil),                   // 31: scada_layout.GetAlarmFieldsResponse.FieldDetail
	(*GetAlarmFieldsResponse_Element)(nil),                       // 32: scada_layout.GetAlarmFieldsResponse.Element
	(*GetAlarmFieldsResponse_Limit)(nil),                         // 33: scada_layout.GetAlarmFieldsResponse.Limit
	nil,                                                          // 34: scada_layout.GetAlarmFieldsResponse.FieldDetail.TransEntry
	(*GetElectricityDemandResponse_ElectricityDemandDetail)(nil), // 35: scada_layout.GetElectricityDemandResponse.ElectricityDemandDetail
	(*GetElectricityDemandResponse_ChartColor)(nil),              // 36: scada_layout.GetElectricityDemandResponse.ChartColor
	(*GetElectricityDemandResponse_InputLimit)(nil),              // 37: scada_layout.GetElectricityDemandResponse.InputLimit
	(*GetElectricityDemandResponse_LimitDetail)(nil),             // 38: scada_layout.GetElectricityDemandResponse.LimitDetail
	(*GetElectricityDemandResponse_GroupDetail)(nil),             // 39: scada_layout.GetElectricityDemandResponse.GroupDetail
	(*GetElectricityDemandResponse_ElementDetail)(nil),           // 40: scada_layout.GetElectricityDemandResponse.ElementDetail
	(*GetElectricityDemandResponse_FieldDetail)(nil),             // 41: scada_layout.GetElectricityDemandResponse.FieldDetail
	(*GetElectricityDemandResponse_TimingField)(nil),             // 42: scada_layout.GetElectricityDemandResponse.TimingField
	(*emptypb.Empty)(nil),                                        // 43: google.protobuf.Empty
}
var file_scada_layout_proto_scada_layout_proto_depIdxs = []int32{
	14, // 0: scada_layout.GetFieldsTagsResponse.field_tags:type_name -> scada_layout.GetFieldsTagsResponse.FieldTag
	16, // 1: scada_layout.GetReportFieldsResponse.fields:type_name -> scada_layout.GetReportFieldsResponse.Field
	1,  // 2: scada_layout.GetFieldListRequest.type:type_name -> scada_layout.GetFieldListRequest.RequestType
	2,  // 3: scada_layout.GetFieldListRequest.field_type:type_name -> scada_layout.GetFieldListRequest.FieldType
	18, // 4: scada_layout.GetSmartDefrostResponse.groups:type_name -> scada_layout.GetSmartDefrostResponse.GroupDetail
	21, // 5: scada_layout.GetReportResponse.pdf_setting:type_name -> scada_layout.GetReportResponse.ReportSettingDetail
	21, // 6: scada_layout.GetReportResponse.excel_setting:type_name -> scada_layout.GetReportResponse.ReportSettingDetail
	22, // 7: scada_layout.GetReportResponse.pdf_input:type_name -> scada_layout.GetReportResponse.PdfInputDetail
	23, // 8: scada_layout.GetReportResponse.excel_input:type_name -> scada_layout.GetReportResponse.ExcelIntervalDetail
	25, // 9: scada_layout.GetReportResponse.default_charts:type_name -> scada_layout.GetReportResponse.DefaultChart
	28, // 10: scada_layout.GetScenarioResponse.elements:type_name -> scada_layout.GetScenarioResponse.ElementScenario
	31, // 11: scada_layout.GetAlarmFieldsResponse.fields:type_name -> scada_layout.GetAlarmFieldsResponse.FieldDetail
	36, // 12: scada_layout.GetElectricityDemandResponse.chart_color:type_name -> scada_layout.GetElectricityDemandResponse.ChartColor
	35, // 13: scada_layout.GetElectricityDemandResponse.demand_list:type_name -> scada_layout.GetElectricityDemandResponse.ElectricityDemandDetail
	15, // 14: scada_layout.GetFieldsTagsResponse.FieldTag.equipments:type_name -> scada_layout.GetFieldsTagsResponse.IdWithName
	15, // 15: scada_layout.GetFieldsTagsResponse.FieldTag.groups:type_name -> scada_layout.GetFieldsTagsResponse.IdWithName
	15, // 16: scada_layout.GetFieldsTagsResponse.FieldTag.floors:type_name -> scada_layout.GetFieldsTagsResponse.IdWithName
	17, // 17: scada_layout.GetReportFieldsResponse.Field.trans:type_name -> scada_layout.GetReportFieldsResponse.Field.TransEntry
	19, // 18: scada_layout.GetSmartDefrostResponse.GroupDetail.elements:type_name -> scada_layout.GetSmartDefrostResponse.ElementDetail
	20, // 19: scada_layout.GetSmartDefrostResponse.ElementDetail.fields:type_name -> scada_layout.GetSmartDefrostResponse.ServerSettingField
	24, // 20: scada_layout.GetReportResponse.PdfInputDetail.interval:type_name -> scada_layout.GetReportResponse.IntervalDetail
	24, // 21: scada_layout.GetReportResponse.ExcelIntervalDetail.interval:type_name -> scada_layout.GetReportResponse.IntervalDetail
	24, // 22: scada_layout.GetReportResponse.ExcelIntervalDetail.data_interval:type_name -> scada_layout.GetReportResponse.IntervalDetail
	26, // 23: scada_layout.GetReportResponse.DefaultChart.chart_fields:type_name -> scada_layout.GetReportResponse.DefaultChart.ChartField
	27, // 24: scada_layout.GetReportResponse.DefaultChart.ChartField.trans:type_name -> scada_layout.GetReportResponse.DefaultChart.ChartField.TransEntry
	29, // 25: scada_layout.GetScenarioResponse.ElementScenario.scenarios:type_name -> scada_layout.GetScenarioResponse.ScenarioDetail
	30, // 26: scada_layout.GetScenarioResponse.ScenarioDetail.field_actions:type_name -> scada_layout.GetScenarioResponse.FieldAction
	32, // 27: scada_layout.GetAlarmFieldsResponse.FieldDetail.elements:type_name -> scada_layout.GetAlarmFieldsResponse.Element
	33, // 28: scada_layout.GetAlarmFieldsResponse.FieldDetail.limit:type_name -> scada_layout.GetAlarmFieldsResponse.Limit
	0,  // 29: scada_layout.GetAlarmFieldsResponse.FieldDetail.unit_type:type_name -> scada_layout.UnitType
	34, // 30: scada_layout.GetAlarmFieldsResponse.FieldDetail.trans:type_name -> scada_layout.GetAlarmFieldsResponse.FieldDetail.TransEntry
	37, // 31: scada_layout.GetElectricityDemandResponse.ElectricityDemandDetail.input_limit:type_name -> scada_layout.GetElectricityDemandResponse.InputLimit
	39, // 32: scada_layout.GetElectricityDemandResponse.ElectricityDemandDetail.groups:type_name -> scada_layout.GetElectricityDemandResponse.GroupDetail
	42, // 33: scada_layout.GetElectricityDemandResponse.ElectricityDemandDetail.timing_fields:type_name -> scada_layout.GetElectricityDemandResponse.TimingField
	38, // 34: scada_layout.GetElectricityDemandResponse.InputLimit.target_electricity:type_name -> scada_layout.GetElectricityDemandResponse.LimitDetail
	38, // 35: scada_layout.GetElectricityDemandResponse.InputLimit.restricted_mins:type_name -> scada_layout.GetElectricityDemandResponse.LimitDetail
	38, // 36: scada_layout.GetElectricityDemandResponse.InputLimit.electricity:type_name -> scada_layout.GetElectricityDemandResponse.LimitDetail
	38, // 37: scada_layout.GetElectricityDemandResponse.InputLimit.elapsed_mins:type_name -> scada_layout.GetElectricityDemandResponse.LimitDetail
	40, // 38: scada_layout.GetElectricityDemandResponse.GroupDetail.elements:type_name -> scada_layout.GetElectricityDemandResponse.ElementDetail
	41, // 39: scada_layout.GetElectricityDemandResponse.ElementDetail.fields:type_name -> scada_layout.GetElectricityDemandResponse.FieldDetail
	4,  // 40: scada_layout.ScadaLayoutService.GetFieldsTags:input_type -> scada_layout.FieldList
	4,  // 41: scada_layout.ScadaLayoutService.GetReportFields:input_type -> scada_layout.FieldList
	7,  // 42: scada_layout.ScadaLayoutService.GetFieldsWithId:input_type -> scada_layout.GetFieldListRequest
	43, // 43: scada_layout.ScadaLayoutService.GetSmartDefrost:input_type -> google.protobuf.Empty
	43, // 44: scada_layout.ScadaLayoutService.GetReport:input_type -> google.protobuf.Empty
	43, // 45: scada_layout.ScadaLayoutService.GetScenario:input_type -> google.protobuf.Empty
	43, // 46: scada_layout.ScadaLayoutService.GetAlarmFields:input_type -> google.protobuf.Empty
	43, // 47: scada_layout.ScadaLayoutService.GetElectricityDemand:input_type -> google.protobuf.Empty
	5,  // 48: scada_layout.ScadaLayoutService.GetFieldsTags:output_type -> scada_layout.GetFieldsTagsResponse
	6,  // 49: scada_layout.ScadaLayoutService.GetReportFields:output_type -> scada_layout.GetReportFieldsResponse
	8,  // 50: scada_layout.ScadaLayoutService.GetFieldsWithId:output_type -> scada_layout.GetFieldListResponse
	9,  // 51: scada_layout.ScadaLayoutService.GetSmartDefrost:output_type -> scada_layout.GetSmartDefrostResponse
	10, // 52: scada_layout.ScadaLayoutService.GetReport:output_type -> scada_layout.GetReportResponse
	11, // 53: scada_layout.ScadaLayoutService.GetScenario:output_type -> scada_layout.GetScenarioResponse
	12, // 54: scada_layout.ScadaLayoutService.GetAlarmFields:output_type -> scada_layout.GetAlarmFieldsResponse
	13, // 55: scada_layout.ScadaLayoutService.GetElectricityDemand:output_type -> scada_layout.GetElectricityDemandResponse
...
func file_scada_layout_proto_scada_layout_proto_init() {
	...
	file_scada_layout_proto_scada_layout_proto_msgTypes[33].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_scada_layout_proto_scada_layout_proto_rawDesc), len(file_scada_layout_proto_scada_layout_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   39,
			NumExtensions: 0,
			NumServices:   1,
