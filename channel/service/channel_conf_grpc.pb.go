...
func (c *channelConfClient) GetConfCacheKey(ctx context.Context, in *GetConfRequest, opts ...grpc.CallOption) (*GetConfCacheKeyReply, error) {
	out := new(GetConfCacheKeyReply)
	err := c.cc.Invoke(ctx, "/service.ChannelConf/GetConfCacheKey", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ChannelConf_GetConfCacheKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(ChannelConfServer).GetConfCacheKey(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service.ChannelConf/GetConfCacheKey",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChannelConfServer).GetConfCacheKey(ctx, req.(*GetConfRequest))
	}
	return interceptor(ctx, in, info, handler)
}
