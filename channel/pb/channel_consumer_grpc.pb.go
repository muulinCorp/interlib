...
func (c *comsumerServiceClient) WarningChecking(ctx context.Context, in *WarningCheckingReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/channel.ComsumerService/WarningChecking", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ComsumerService_WarningChecking_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WarningCheckingReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ComsumerServiceServer).WarningChecking(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/channel.ComsumerService/WarningChecking",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ComsumerServiceServer).WarningChecking(ctx, req.(*WarningCheckingReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ComsumerService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "channel.ComsumerService",
	...
	Metadata: "channel/proto/channel_consumer.proto",
}
